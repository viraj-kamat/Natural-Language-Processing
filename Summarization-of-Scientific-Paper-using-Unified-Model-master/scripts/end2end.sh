TRAIN_PATH='data/finished_files/train*'
VAL_PATH='data/finished_files/val*'
...
INCONSISTENT_TOPK=3
SELECTOR_PATH='log/selector/exp_sample/eval/bestmodel-26580.data-00000-of-00001'
REWRITER_PATH='log/rewriter/exp_sample/train/model.ckpt_cov-89000.data-00000-of-00001'
...
CKPT_PATH="pretrained/bestmodel-51000"
