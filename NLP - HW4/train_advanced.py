...
if __name__ == '__main__':
    ...
    parser.add_argument("--filter_sizes", default="2,3,4,5",type=str, help="Comma separated filters. Integers 1-5.")
    ...
    config = {'vocab_size': vocab_size, 'embed_dim': args.embed_dim, 'training': True, 'num_filters' : args.num_filters , 'filter_sizes' : args.filter_sizes}
    #Two new arguments, num_filters & filter_sizes
