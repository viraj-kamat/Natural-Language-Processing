...
python /content/drive/My\ Drive/NLP\ HW3/assignment3/assignment3/train.py \
 /content/drive/My\ Drive/NLP\ HW3/assignment3/assignment3/data/train.conll \
 /content/drive/My\ Drive/NLP\ HW3/assignment3/assignment3/data/dev.conll \ 
 --pretrained-embedding-file data/glove.6B.50d.txt \
 --cache-processed-data --experiment-name basic
